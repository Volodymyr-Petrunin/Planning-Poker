...
public class ExpectedEntityDtoUtils {
    private static final UserDto USER_ELECTOR = UserDtoFactory.createExpectedElectorDto();
    private static final UserDto USER_CREATOR = UserDtoFactory.createExpectedCreatorDto();
    ...
    public static UserDto getUserElector() {
        return USER_ELECTOR;
    }

    public static UserDto getUserCreator() {
        return USER_CREATOR;
    }
